...
export default function FR() {
  ...
  return (
    <>
      ...
      <div className="hero">
        <p className="eyebrow fa d1">Arrête de payer 3 000$/mois à des agences</p>
        <h1 className="h1 fa d2">Vire ton agence.<em>Possède ton marketing.</em></h1>
        <p className="hero-sub fa d3">Aucune expérience en marketing? Pas de problème. Tu paies une agence sans voir les résultats? Grip donne à tout propriétaire d'entreprise un système marketing complet qu'il peut bâtir, gérer et posséder — certifié.</p>
        <div className="hook-tabs fa d4">
          <button className="htab on">Anti-Agence</button>
          <button className="htab">Actif ROI</button>
          <button className="htab">Contrôle</button>
